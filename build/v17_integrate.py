...
CSS_MARK='/* War Room v1.7 Raid Intelligence */'; JS_MARK='/* War Room v1.7 - TBC Phase 3 Raid Intelligence */'; REFRESH_MARK='/* War Room v1.7.8 - Spec Refresh Bridge */'; ARMORY_MARK='/* War Room v1.7.9 - ClassicArmory Structured API */'; UI_MARK='/* War Room v1.7 - live Raid Intelligence dashboard */'
if CSS_MARK in h:
