...
if final.count(GRAPHICS_MARK)!=1 or final.count(ARMORY_MARK)!=1 or final.count(MODEL_MARK)!=1: raise RuntimeError('Duplicate/missing v1.7.26 modules')
...
print('War Room v1.7.26 character model manifest integration complete')
